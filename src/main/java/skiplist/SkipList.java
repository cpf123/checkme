...
public class SkipList<T> {
    ...
    public SkipNode search(int key) { // https://zhuanlan.zhihu.com/p/339750543
        ...
        while (team != null) {
            ...
            {
                team = team.down;
            } else if (team.right.key > key)//需要下降去寻找 右侧较大向下 类似于二分法
            {
                team = team.down; // team.right的前一个节点 肯定小于key 二分法验证逻辑
            } else //右侧比较小向右
            {
                team = team.right;
            }
